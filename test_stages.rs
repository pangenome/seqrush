...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let input_file = "b3106.seqwish.gfa";
    let verbose = true;

    eprintln!("[test_stages] Reading input GFA from {}", input_file);
    ...
    eprintln!("[test_stages] Loaded graph: {} nodes, {} edges, {} paths",
