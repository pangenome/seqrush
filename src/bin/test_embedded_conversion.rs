...
fn main() {
    ...
    match convert_to_embedded(&bi_graph) {
        Ok(embedded) => {
            ...
            println!("  Nodes: {}, Paths: {}", embedded.nodes.len(), embedded.paths.len());
    ...
    // Path 1: A->B->D
    bi_graph3.build_path("path1".to_string(), vec![(1, false), (2, false), (4, false)]);
    // Path 2: A->C->D  
    bi_graph3.build_path("path2".to_string(), vec![(1, false), (3, false), (4, false)]);
    ...
    bi_graph4.build_path("circular".to_string(), vec![
        (1, false), (2, false), (3, false), (2, false), (1, false)
    ]);
